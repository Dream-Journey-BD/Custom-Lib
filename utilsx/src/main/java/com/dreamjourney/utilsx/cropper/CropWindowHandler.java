...
final class CropWindowHandler {
    ...
    public float getMaxCropWidth() {
        return Math.min(
                mMaxCropWindowWidth,
                mMaxCropResultWidth / mScaleFactorWidth
        );
    }
    ...
    public void setMaxCropResultSize(
            int maxCropResultWidth, int maxCropResultHeight
    ) {
    ...
    private static boolean isInHorizontalTargetZone(
            float x, float y, float handleXStart,
