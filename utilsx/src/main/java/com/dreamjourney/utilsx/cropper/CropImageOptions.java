...
public class CropImageOptions implements Parcelable {
    ...
    protected CropImageOptions(@NonNull Parcel in) {
    ...
    public void validate() {
        if (maxZoom < 0) throw new IllegalArgumentException("Cannot set max zoom to a number < 1");
        if (touchRadius < 0)
        ...
        if (aspectRatioX <= 0) throw new IllegalArgumentException(
                "Cannot set aspect ratio value to a number less than or equal to 0.");
        if (aspectRatioY <= 0) throw new IllegalArgumentException(
                "Cannot set aspect ratio value to a number less than or equal to 0.");
        if (borderLineThickness < 0) throw new IllegalArgumentException(
                "Cannot set line thickness value to a number less than 0.");
        if (borderCornerThickness < 0) throw new IllegalArgumentException(
                "Cannot set corner thickness value to a number less than 0.");
        if (guidelinesThickness < 0) throw new IllegalArgumentException(
                "Cannot set guidelines thickness value to a number less than 0.");
        if (minCropWindowHeight < 0) throw new IllegalArgumentException(
                "Cannot set min crop window height value to a number < 0 ");
        if (minCropResultWidth < 0)
            throw new IllegalArgumentException("Cannot set min crop result width value to a number < 0 ");
        if (minCropResultHeight < 0) throw new IllegalArgumentException(
                "Cannot set min crop result height value to a number < 0 ");
        if (maxCropResultWidth < minCropResultWidth) throw new IllegalArgumentException(
                "Cannot set max crop result width to smaller value than min crop result width");
        if (maxCropResultHeight < minCropResultHeight) throw new IllegalArgumentException(
        ...
        if (rotationDegrees < 0 || rotationDegrees > 360) throw new IllegalArgumentException(
