package com.dreamjourney.imagetilezoom.decoder;
...
/**
 * Default implementation of {@link com.dreamjourney.imagetilezoom.decoder.ImageRegionDecoder}
...
public class SkiaImageRegionDecoder implements ImageRegionDecoder {
    ...
    public SkiaImageRegionDecoder(@Nullable Bitmap.Config bitmapConfig) {
        Bitmap.Config globalBitmapConfig = ImageTileZoomView.getPreferredBitmapConfig();
        this.bitmapConfig = bitmapConfig != null ?
                bitmapConfig : Objects.requireNonNullElse(
                globalBitmapConfig, Bitmap.Config.RGB_565
        );
    }
    ...
    public Point init(Context context, @NonNull Uri uri) throws Exception {
        ...
        if (uriString.startsWith(RESOURCE_PREFIX)) {
            ...
            try {
                ...
                if (inputStream == null) {
                    throw new Exception(
                            "Content resolver returned null stream. " +
        ...
        if (decoder == null) throw new IllegalStateException(
                "BitmapRegionDecoder not initialized"
        );
