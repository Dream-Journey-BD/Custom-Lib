...
import static com.dreamjourney.gpuimage.GPUImageRenderer.CUBE;
...
public class GPUImageFilterGroup extends GPUImageFilter {
     ...
     * (non-Javadoc)
     * @see
     * GPUImageFilter#onOutputSizeChanged(int,
     * int)
     */
    @Override
