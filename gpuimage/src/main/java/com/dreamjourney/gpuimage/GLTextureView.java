...
public class GLTextureView extends TextureView
    ...
    private class DefaultContextFactory implements EGLContextFactory {
        ...
        public EGLContext createContext(@NonNull EGL10 egl, EGLDisplay display, EGLConfig config) {
    ...
    private class ComponentSizeChooser extends BaseConfigChooser {
        ...
        private int findConfigAttrib(
                @NonNull EGL10 egl, EGLDisplay display, EGLConfig config, int attribute
        ) {
